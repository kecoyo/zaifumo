...
class Bullet {
  ...
  constructor(
    ...
    span.setAttribute(
      'style',
      `text-shadow: ${'#000 1px 0px 1px, #000 0px 1px 1px, #000 0px -1px 1px,#000 -1px 0px 1px'}; color: ${options.color || '#fff'}; font-size: ${'25px'};`
    );
    span.style.opacity = String(options.opacity);
    span.innerText = node;
